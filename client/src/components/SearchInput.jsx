      ...
      <form className="flex items-center" onSubmit={handleSearch}>
        ...
        <div className="relative z-0 w-96">
          ...
          <input
            ...
            type="text"
            id="simple-search"
            className="bg-gray-50 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:outline-none block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500 text-black"
            placeholder="Search"
          />
        </div>
        <button
