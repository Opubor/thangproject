      ...
      <table className="w-full">
        ...
        <tbody>
          ...
          <tr className="text-sm font-semibold">
            <td className="flex justify-start items-center gap-2 py-4 px-2">
              <input type="checkbox" className="w-4" />
              <p className="font-semibold">File1-6</p>
            </td>
            <td>
              <p className="border-l-2 border-l-gray-400 border-r-2 border-r-gray-400 mx-2 px-2">
                Login page loads from homepage
          ...
          <tr className="text-sm font-semibold">
            <td className="flex justify-start items-center gap-2 py-4 px-2">
              <input type="checkbox" className="w-4" />
              <p className="font-semibold">File1-7</p>
            </td>
            <td>
              <p className="border-l-2 border-l-gray-400 border-r-2 border-r-gray-400 mx-2 px-2">
                Login page loads from homepage
          ...
          <tr className="text-sm font-semibold">
            <td className="flex justify-start items-center gap-2 py-4 px-2">
              <input type="checkbox" className="w-4" />
              <p className="font-semibold">File1-8</p>
            </td>
            <td>
              <p className="border-l-2 border-l-gray-400 border-r-2 border-r-gray-400 mx-2 px-2">
                Login page loads from homepage
          ...
          <tr className="text-sm font-semibold">
            <td className="flex justify-start items-center gap-2 py-4 px-2">
              <input type="checkbox" className="w-4" />
              <p className="font-semibold">File1-9</p>
            </td>
            <td>
              <p className="border-l-2 border-l-gray-400 border-r-2 border-r-gray-400 mx-2 px-2">
                Login page loads from homepage
          ...
          <tr className="text-sm font-semibold">
            <td className="flex justify-start items-center gap-2 py-4 px-2">
              <input type="checkbox" className="w-4" />
              <p className="font-semibold">File1-10</p>
            </td>
            <td>
              <p className="border-l-2 border-l-gray-400 border-r-2 border-r-gray-400 mx-2 px-2">
                Login page loads from homepage
