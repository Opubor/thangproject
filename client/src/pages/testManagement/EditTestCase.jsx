...
function EditTestCase({ styles, setsetOpenEditModal, EditCaseRef }) {
      ...
      >
        <div className="flex justify-between items-center text-xl font-semibold">
          <div className="flex justify-center items-center gap-4 text-xl text-textdark">
            ...
            <h1 className="flex items-center gap-2 truncate w-32">
              {testcase?.title}
            </h1>
          </div>
        </div>
              ...
              <Form>
                ...
                <div className="flex justify-center items-center gap-12 mt-8">
                  <Link
                    to={`/test_management?folder=${folderId}&table=${tableId}`}
                    onClick={setsetOpenEditModal}
                    className="bg-red-600 px-4 py-2 text-white rounded-md hover:bg-red-700 cursor-pointer text-sm"
                  >
                    <span>Cancel</span>
                  </Link>
                  <button
